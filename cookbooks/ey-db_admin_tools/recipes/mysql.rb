...
include_recipe "ey-db_admin_tools::mytop"

if node["dna"]["instance_role"][/^(db|solo)/]
  include_recipe "ey-db_admin_tools::innotop"
  include_recipe "ey-db_admin_tools::percona_toolkit"
end

# Adding 'db_replica' attribute for future compatibility
if ["db_master", "db_slave", "db_replica"].include?(node["dna"]["instance_role"])
  include_recipe "ey-db_admin_tools::binary_logs"
end
